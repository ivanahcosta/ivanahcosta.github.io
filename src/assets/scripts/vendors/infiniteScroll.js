...
!(function (t, e) {
  ...
  (function (t, e) {
    ...
    (r.create = function () {
      let t = (this.guid = ++l);
      if (
        ((this.element.infiniteScrollGUID = t), (o[t] = this), (this.pageIndex = 1), (this.loadCount = 0), this.updateGetPath(), this.getPath && this.getPath())
      ) {
  ...
  (function (t, e) {
    ...
    let i = e.prototype;
    Object.assign(e.defaults, { loadOnScroll: !0, checkLastPage: !0, responseBody: 'text', domParseResponse: !0 }),
          ...
          .then((i) => {
            ...
            return i[t]().then(
              (s) => (
                ...
                204 == i.status ? (this.lastPageReached(s, o), { body: s, response: i }) : this.onPageLoad(s, o, i)
              ),
            );
          })
          .catch((t) => {
      ...
      (n.getBottomDistance = function () {
        ...
        return (
          this.options.elementScroll
            ? ((e = this.scroller.scrollHeight), (i = this.scroller.scrollTop + this.scroller.clientHeight))
  ...
  (function (t, e) {
    ...
    return (
      ...
      (n.setHistory = function (t, e) {
        ...
        i &&
          history[i + 'State'] &&
          (history[i + 'State'](null, t, e), this.options.historyTitle && (document.title = t), this.dispatchEvent('history', null, [t, e]));
      }),
      (n.onUnload = function () {
  ...
  (function (t, e) {
    ...
    function r(t, e, l) {
      ...
      ('string' == typeof t && (a = document.querySelectorAll(t)), a)
        ? ((this.elements = ((h = a), Array.isArray(h) ? h : 'object' == typeof h && 'number' == typeof h.length ? s.call(h) : [h])),
